...
class Menu extends React.Component {
    ...
    this._onMenuLayout = (event) => {
      ...
      if (menuState === 0 /* MEASURING */) {
        this.setState({
          ...
          menu: Object.assign(Object.assign({}, menu), { width, height })
        });
      }
    };
    this._onDismiss = () => {
  ...
  componentDidUpdate() {
    ...
    if (menuState === 1 /* CALCULATING */) {
      ...
      this.setState({
        menuState: 2 /* SHOWN */,
        menu: Object.assign(Object.assign({}, menu), {
  ...
  render() {
    ...
    return (
      <react_native_1.View collapsable={false} testID={testID}>
...
const styles = react_native_1.StyleSheet.create({
  shadowMenuContainer: Object.assign(
    {
      position: 'absolute',
